      ...
      <Card className="border-0 shadow-2xl bg-white/95 dark:bg-card/95 backdrop-blur-xl rounded-2xl">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-11 rounded-xl border-border/60 bg-background/50 focus-visible:bg-background transition-colors"
              />
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-11 rounded-xl border-border/60 bg-background/50 pr-10 focus-visible:bg-background transition-colors"
                />
                <button
                  type="button"
          ...
          <CardFooter className="flex flex-col gap-4 pt-2">
            <Button type="submit" className="w-full h-11 rounded-xl" variant="premium" disabled={loading}>
